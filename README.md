...
```
transmit info. when something is digitally assigned each key token is different. so its safer.
```

3. Why would we hash a user's password when they sign up? What's the point?

```
verify and protect the safety of the password
```
...
```
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEiLCJ1c2VybmFtZSI6ImFuZ2llIiwiZW1haWwiOiJhbmdpZUBnYS5jbyJ9.u7cGJQc-k74-ecnKD40mkNIKScyGGfALcFQhE7jkofs
```
